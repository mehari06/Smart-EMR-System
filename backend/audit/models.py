...
class AuditLog(models.Model):
    ACTION_CHOICES = [
        ...
        ('VERIFY_LAB_RESULT', 'Verify Lab Result'),
        ('ORDER_RADIOLOGY', 'Order Radiology'),
        ('RECEIVE_RADIOLOGY_RESULT', 'Receive Radiology Result'),
        ('VERIFY_RADIOLOGY_RESULT', 'Verify Radiology Result'),
