...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:ring-2 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-2 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        warning: "bg-warning text-slate-950 shadow-sm hover:bg-warning/90",
        danger: "bg-danger text-white shadow-sm hover:bg-danger/90",
        loading: "bg-primary text-primary-foreground opacity-80 shadow-sm",
        ...
        destructive:
          "bg-danger text-white shadow-sm hover:bg-danger/90 focus-visible:border-danger/40 focus-visible:ring-danger/20",
